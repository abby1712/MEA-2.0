...
float Temp_sensor_value;
  ...
  sheetTemp = String(value)+String("*C");
...
if( Temp_sensor_value > 65 && light_sensor_value > 85)
{
   IFTTT_Trigger_Fire();
   delay(1000);
}
